...
const greetings = ["నమస్తే","Hello", "Hallo", "Bonjour"]; // English, German, French, Telugu
        ...
        <h1 className="text-4xl md:text-8xl font-bold mb-10">
          ...
          <span className='animated-gradient'>
            ...
            I'm <span className='name-container'>
              <span className='animated-gradient full-name'>Akhil Marni</span>
              <span className='animated-gradient short-name'>Akhil</span>
            </span>
          </span>
        </h1>
        <div>
