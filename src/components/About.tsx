            ...
            <div className="bg-transparent rounded-lg shadow-lg px-5 py-6 sm:px-6 my-10 w-full max-w-3xl mx-auto border blur-background2 mt-0">
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-200">
                  I am a final-year undergraduate student with a strong passion for Artificial Intelligence and Machine Learning. I have hands-on experience in data science, deep learning, generative AI, and large language models. I thrive on solving complex problems with innovative solutions. 
                  <br /><br />
                  I have been explorimg many subjects during my undegrgration at IIT Madras. I am always eager to learn new things and continuously expand my skill set. Explore my portfolio to see my latest projects and research endeavors.
                </p>
